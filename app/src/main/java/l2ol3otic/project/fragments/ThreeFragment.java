...
public class ThreeFragment extends Fragment {
    ...
    private int LayoutID[] = new int[]{R.id.lu1,R.id.lu2,R.id.lu3,R.id.lu4,R.id.lu5,R.id.lu6,R.id.lu7,R.id.lu8,R.id.lu9,R.id.lu10,R.id.lu11,R.id.lu12,R.id.lu13,R.id.lu14,R.id.lu15,R.id.lu16,R.id.lu17,R.id.lu18,R.id.lu19,R.id.lu20,R.id.lu21,R.id.lu22, R.id.lu23, R.id.lu24, R.id.lu25, R.id.lu26, R.id.lu27, R.id.lu28, R.id.lu29, R.id.lu30, R.id.lu31, R.id.lu32};
